...
#### sh -c "\`curl -fsSL https://raw.githubusercontent.com/jasonwbarnett/skwp-dotfiles/my-changes/install.sh \`"
...
```bash
sh -c "`curl -fsSL https://raw.githubusercontent.com/jasonwbarnett/skwp-dotfiles/my-changes/install.sh`" -s ask
```
